...
For this next question, please provide a list with the name of the director with the most Oscar wins. We are asking for a list because there could be more than 1 director with the most Oscar wins.
"""

# For Question 2: Please provide a list with the name of the director with the most Oscar wins. Remember, a list will hold the names of multiple directors as there can be more than 1 director with the most Oscar wins.
print("===Q.2")

# Add your code here
most_win_director = [
    director
    for director in win_count_dict.keys()
    if win_count_dict[director] == max(win_count_dict.values())
]
