...
for _ in range(int(input())):
    ...
    domain_pattern = r"https?://(?:(?:(?:www)|(?:ww2))\.)?([\w-]+(?:\.[a-zA-Z0-9-]+)+)"

    for found in re.findall(domain_pattern, line):
        domains.append(found)


print(*sorted(set(domains), key=str), sep=";")
...
# coursera-placement-resumes.s3.amazonaws.com;coursera.org;d2wvvaown1ul17.cloudfront.net;eventing.coursera.org;linkedin.com;ogp.me;s3.amazonaws.com;schema.org;ssl.google;thelearningpoint.net
